...
import { TransactionsOrdersTablePrint } from "./TransactionsOrdersTablePrint";
import { Export2Doc } from "../../../Helpers/functions";
export class TransactionsOrdersTableExportModal extends React.PureComponent {
  render() {
    const { handleToggleExportTable, TransactionsOrders } = this.props;
    return (
      <>
            ...
            <div className="h-full overflow-auto md:w-1/2 w-full mx-auto flex flex-col">
              <div className="m-2 md:m-12">
                <div className="relative p-4 md:p-8 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400 ">
                  ...
                  />
                  <button
                    onClick={Export2Doc("ordersTable", "OrdersTable")}
                  ...
                  />
                  <div
                    onClick={handleToggleExportTable}
        ...
        <div className="hidden">
          <TransactionsOrdersTablePrint
            TransactionsOrdersProps={TransactionsOrders}
