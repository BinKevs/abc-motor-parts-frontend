...
import { TransactionItemTablePrint } from "./TransactionItemTablePrint";
export class TransactionItemsTableExportModal extends React.PureComponent {
  render() {
    const { OnToggleExportTable, TransactionItems } = this.props;
    return (
      <>
              ...
              <div className="m-2 md:m-12">
                <div className="relative p-4 md:p-8 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400 ">
                  ...
                  <ReactHTMLTableToExcel
                    ...
                    table="Transaction-Items-table"
                    filename="Transaction-Items-table"
                    sheet="Transaction-Items-table"
                    buttonText="Excel"
                  />
        ...
        <div className="hidden">
          <TransactionItemTablePrint
            TransactionItemsProps={TransactionItems}
