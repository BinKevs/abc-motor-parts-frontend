...
const ReplenishmentInventorySupplierModal = (props) => {
  const {
    products,
    suppliers,
    onChange,
          ...
          >
            ...
            <div className="h-full overflow-auto w-full flex flex-col">
              <div className="m-2 md:m-12">
                <form onSubmit={handleSubmitUpdateInventory(inventoryID)}>
                    ...
                    <div className="">
                      <div class="relative z-0 w-full mb-5">
                        <input
                          ...
                          placeholder=" "
                          required
                          class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 text-center text-2xl appearance-none focus:outline-none focus:ring-0 focus:border-cyan-700 border-gray-200"
...
export default connect(null, {})(ReplenishmentInventorySupplierModal);
