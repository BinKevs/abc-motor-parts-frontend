...
import { AttendanceLogTablePrint } from './AttendanceLogTablePrint';
export class AttendanceTableExportModal extends React.PureComponent {
	render() {
		const { OnToggleExportTable, attendanceLog } = this.props;
		return (
			<>
							...
							<div className="m-2 md:m-12">
								<div className="relative p-4 md:p-8 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-md rounded border border-gray-400 ">
									...
									<ReactHTMLTableToExcel
										...
										table="AttendanceLog-table"
										filename="AttendanceLog-table"
										sheet="AttendanceLog-table"
										buttonText="Excel"
									/>
				...
				<div className="hidden">
					<AttendanceLogTablePrint
						AttendanceLogProps={attendanceLog}
